...
<body class="bg-brand-cream font-body min-h-screen">
    ...
    <div class="absolute inset-0 overflow-hidden pointer-events-none">
        <div class="absolute top-20 right-20 w-4 h-4 bg-brand-yellow rounded-full animate-bounce"></div>
        <div class="absolute top-60 left-32 w-6 h-6 bg-yellow-400 rounded-full opacity-60"></div>
        <div class="absolute bottom-40 right-16 w-3 h-3 bg-brand-amber rounded-full"></div>
        <div class="absolute top-40 right-1/3 w-2 h-2 bg-yellow-300 rounded-full"></div>
    </div>
    ...
    <div class="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="max-w-lg w-full">
            ...
            <div class="text-center mb-8">
                ...
                <h2 class="text-3xl font-bold text-gray-900 mb-2">Join Cafe For You</h2>
                <p class="text-gray-600">Create your account and start your culinary journey</p>
            </div>
                ...
                <form method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea id="address" name="address" rows="3"
                                  class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-brand-yellow focus:border-transparent transition-all duration-300 text-gray-900 placeholder-gray-500 resize-none"
                                  placeholder="Enter your address (optional)"><?= htmlspecialchars(getPostValue('address')) ?></textarea>
                    </div>
                    ...
                    <div class="bg-yellow-50 border border-yellow-200 rounded-xl p-4">
                        <p class="text-sm text-gray-600 mb-2 font-medium">Password Requirements:</p>
